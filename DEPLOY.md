...
- Note that the `bobfilez` shell project handles user-facing web services and OS-level integrations. The BQt kernel itself should remain agnostic to external service keys unless explicitly bridging core telemtry.
