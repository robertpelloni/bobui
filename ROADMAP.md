...
- **Phase 4: World Domination:** The shell integration API (`internal/shell/shell_integration.go`) has been successfully established. Exploratory parity spikes for JavaFX, WinUI, and DearImGui have been scaffolded and verified against the non-blocking BQt EventLoop. The BQt kernel is now safely exposed for `bobfilez` consumption.
